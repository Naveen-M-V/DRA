...
export default function Hero({ project }: HeroProps) {
  return (
    <section className="relative min-h-[100svh] overflow-hidden bg-[#073a2f] text-white lg:h-[100svh]">
      ...
      <div className="relative mx-auto grid min-h-[100svh] max-w-7xl grid-cols-1 gap-6 px-4 py-6 md:px-8 md:py-8 lg:h-[100svh] lg:grid-cols-[1.2fr_0.55fr_0.9fr] lg:items-center lg:gap-6 lg:py-6">
        ...
        <div className="pointer-events-none hidden lg:flex lg:items-end lg:justify-center lg:self-end lg:pb-4">
          <Image
            src={repImage}
            alt="DRA Representative"
            width={330}
            height={520}
            className="h-auto w-[200px] xl:w-[280px]"
            priority
          />
        </div>
